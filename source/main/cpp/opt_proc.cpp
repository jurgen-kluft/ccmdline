...
#define OPT_VERSION 3.19
	...
	*/
	...
	static s32		backup_file(char *fname);
	...
	*/
	...
	xargv *
		opt_process(s32 argc, char **argv)
	{
		char	c;
		s32		iword;
		xargv	*ag;
...
POSITIONAL:
	...
	*/
	...
	static s32
		line2argv(s32 *pargc, char ***pargv, char *line)
	{
		char *lincp;
		if(line==NULL) {	
			*pargc = 0;
...
#define	BKSLASH	'\\'
	...
	*/
	...
	static s32
		break_word(s32 inquote, char *line)
	{
